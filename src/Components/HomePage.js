        ...
        <div>
          ...
          <section className="quick-and-reliable-section">
            <div className="quick-and-reliable-section-div-one">
              ...
              <span id="para-one">
                Our job is to get you everything you need
              </span>{" "}
              <br />
              <span id="para-two">
              ...
              <br /> <br />
              <Link to="/Login">
                <button className="quick-and-reliable-section-div-button">
                  Schedule Delivery
                </button>
              </Link>
            </div>
          ...
          <section className="who-we-are">
            ...
            <div className="who-we-are-div-two">
              <h2>Who We Are</h2>
              <span className="who-we-are-div-para">
                Zigara is a logistics company that makes goods delivery simple
                and stress-free. We provide services that are quick, safe, and
                dependable. We render safe, fast and reliable delivery of goods
                and services.
              </span>
            </div>
          </section>
          ...
          <section className="how-we-work">
            ...
            <div className="how-we-work-div-one">
              ...
              <div className="how-we-work-div-one-text">
                ...
                <span className="how-we-work-div-one-text-para">
                  We recognize the importance of technology in delivering a
                  superior customer experience. As a result, our procedures,
                  products, and services are designed to take use of
                  contemporary technology to help us transport your items or
                  goods more affordably, safely, and quickly.
                </span>
              </div>
            </div>
            ...
            <div className="how-we-work-div-two">
              <div className="how-we-work-div-two-text">
                ...
                <span className="how-we-work-div-two-text-para">
                  You can contact our customer service agent via phone <br /> or
            ...
            <div className="how-we-work-div-three">
              ...
              <div className="how-we-work-div-three-text">
                ...
                <span className="how-we-work-div-three-text-para">
                  Our drivers can assist you in delivering your commodities or
                  goods to potential clients at a very low cost.
                </span>
              </div>
            </div>
          </section>
          ...
          <section className="why-choose-us">
            <div className="why-choose-us-text">
              <h1>Why Choose Us</h1>
              <p>
                Our customers satisfaction is our priority and we strive to give
                our customers the best services, we are Zigara.
              </p>
            </div>
            ...
            <div className="why-choose-us-div">
              <div className="safe">
                ...
                <h2>Safe</h2>
                <span>
                  We guarantee the safety of your goods as every item for
                  delivery is carefully conveyed to the right destination.
                </span>
              </div>
              <br />
              <div className="fast">
                ...
                <h2>Fast</h2>
                <span>
                  With the best transport system and experienced drivers we
                  ensure that your goods are delivered quickly to the right
                  location.
                </span>
              </div>
              <br />
              <div className="reliable">
                ...
                <h2>Reliable</h2>
                <span>
                  When you call we answer, we are readily available to deliver
          ...
          <section className="we-provide">
            <div className="we-provide-div">
              <div className="we-provide-div-one">
                <img
                  className="we-provide-div-one-img1"
                  src={rectangle1}
                  alt=""
                />
                <img
                  className="we-provide-div-one-img2"
                  src={we_provide}
                  alt=""
                />
              </div>
          ...
          <section className="footer">
            <div className="footer-div-one">
              ...
              <div className="div-links">
                <h2>Links </h2>
                <Link to="">
                  <span className="link1">Our Services</span>
                </Link>{" "}
                <br />
                <Link to="/AboutUs">
                  <span className="link2">About Us</span>
                </Link>{" "}
                <br />
                <Link to="/FAQ">
                  <span className="link3">FAQs</span>
                </Link>{" "}
                <br />
                <Link to="/T_C">
                  <span className="link4">Terms and Conditions</span>
                </Link>
              </div>
              ...
              <div className="div-business-hour">
                ...
                <span>
                  {" "}
                  Monday - Saturday <span>7am-7pm</span>
                </span>{" "}
                <br />
                <span>
                  Sundays <span>8am- 7pm</span>
                </span>
              </div>
            </div>
