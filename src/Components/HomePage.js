...
<div>
      ...
      <br /> <br /> <br /> <br />
          ...
          <span id='para-one'>Our job is to get you everything you need in</span> <br/>
          <span id='para-two'>the shortest amount of time possible.</span> <br /> <br />
      ...
      <section className="why-choose-us">
        <div className="why-choose-use-text">
          <h1>Why Choose Us</h1>
